 ...
 *				 Skillsets:
 *				 	SQL, modeling, denominator file creation, sample population, logistic regression model, model application, backwards elimination, standardized infection ratio modeling, negative binomial regression (in progress)	
 *	
 *------------------------------------------------------------------------------
 */
